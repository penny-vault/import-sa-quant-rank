...
const (
	binaryName   = "import-sa-quant-rank"
	packageName  = "."
	noGitLdflags = "-X github.com/penny-vault/import-sa-quant-rank/common.buildDate=$BUILD_DATE"
)

var ldflags = "-X github.com/penny-vault/import-sa-quant-rank/common.commitHash=$COMMIT_HASH -X github.com/penny-vault/import-sa-quant-rank/common.buildDate=$BUILD_DATE"
